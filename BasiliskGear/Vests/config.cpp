	...
	class CfgWeapons
	{
		class Basilisk_custom_vests
		{
			...
			class role
			{
				alwaysSelectable = 1;
				label = "Role";
				values[] = {"Standard","Soldner","Buckley","Payne","Wolf","Ramirez","Burtovski","Holland","Chop"};
				class Standard
				{
					label = "Standard";
				};
...
class XtdGearInfos
{
	class CfgWeapons
	{
		...
		class Basilisk_Ramirez_M56R_Armor
		{
			model	= "Basilisk_custom_vests";
			role	= "Ramirez";
		};
...
class CfgWeapons
{
	...
	class Basilisk_Ramirez_M56R_Armor : Basilisk_Base_M56R_Armor
	{
		scope = 2;
		scopeArsenal = 2;
		author = "SirChungus";
		displayName = "[Basilisk] M56R Combat Armor (Ramirez)";
		hiddenSelections[] =
		{
			"camo1",
			"camo2",
		...
		hiddenSelectionsTextures[] =
		{
			...
			"BasiliskGear\data\armor\onetwo_H3_Lower_Armor_co.paa",
			"MA_Armor\data\Vests\H3_ODST\Addons\Thigh_Pouch_co.paa",
			"BasiliskGear\data\armor\ramirez_Reach_Upper_Armor_co.paa",
			"BasiliskGear\data\armor\ramirez_Reach_Lower_Armor_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa",
			"BasiliskGear\data\armor\ramirez_Forearm_Vents_co.paa",
			"BasiliskGear\data\armor\ramirez_Sniper_co.paa",
			"BasiliskGear\data\armor\ramirez_CQB_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Addons\Reach_Shoulder_Radio\Shoulder_Radio_Green_co.paa"
		};
		class ItemInfo : ItemInfo
		{
