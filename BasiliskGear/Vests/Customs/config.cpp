	...
	class CfgWeapons
	{
		...
		class Basilisk_Fury_vests
		{
			...
			class role
			{
				alwaysSelectable = 1;
				label = "Role";
				values[] = { "Buckley","Payne","Wolf","Chop","Vargo","Famous","Morningstar"};
				class Buckley {
					label = "Buckley";
				};
				class Payne {
...
class XtdGearInfos
{
	class CfgWeapons
	{
		...
		class Basilisk_Reject_M56R_Armor {
			model	= "Basilisk_custom_vests";
			role	= "Reject";
		};
		...
		class Basilisk_Morningstar_M56R_Armor {
			model	= "Basilisk_Fury_vests";
			role	= "Morningstar";
		};
...
class CfgWeapons
{
	...
	class Basilisk_Standard_M56_Armor: Basilisk_Base_M56R_Armor {
		...
		hiddenSelectionsTextures[] = {
			...
			"BasiliskGear\data\armor\base_Reach_Armor_Upper_co.paa",
			"BasiliskGear\data\armor\base_Reach_Armor_Lower_co.paa",
	...
	class Basilisk_Reject_M56R_Armor : Basilisk_Base_M56R_Armor {
		scope = 2;
		scopeArsenal = 2;
		author = "Soldner";
		displayName = "[Basilisk] M56R Combat Armor (Reject)";
		hiddenSelections[] = {
			"camo1",
			"camo2",
			"camo3",
		...
		hiddenSelectionsTextures[] = {
			"BasiliskGear\data\armor\Reject_H3_Upper_Armor_co.paa",
			"BasiliskGear\data\armor\Reject_H3_Lower_Armor_co.paa",
			"MA_Armor\data\Vests\H3_ODST\Addons\Medic_Thigh_Pouch_co.paa",
			"BasiliskGear\data\armor\Reject_Reach_Armor_Upper_co.paa",
	...
	class Basilisk_Morningstar_M56R_Armor : Basilisk_Base_M56R_Armor {
		...
		hiddenSelectionsTextures[] = {
			"BasiliskGear\data\armor\Morningstar_H3_Armor_Upper_co.paa",
			"BasiliskGear\data\armor\Morningstar_H3_Armor_Lower_co.paa",
			"MA_Armor\data\Vests\H3_ODST\Addons\Medic_Thigh_Pouch_co.paa",
			"BasiliskGear\data\armor\base_Reach_Armor_Upper_co.paa",
			"BasiliskGear\data\armor\base_Reach_Armor_Lower_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa",
	...
	class Basilisk_Bauer_M56R_Armor : Basilisk_Base_M56R_Armor {
		...
		hiddenSelectionsTextures[] = {
			"BasiliskGear\data\armor\Bauer_H3_Upper_Armor_co.paa",
			"BasiliskGear\data\armor\Bauer_H3_Lower_Armor_co.paa",
			"BasiliskGear\data\armor\Bauer_Thigh_Pouch_co.paa",
			"BasiliskGear\data\armor\Bauer_Reach_Armor_Upper_co.paa",
			"MA_Armor\data\Vests\H3_ODST\Reach_Armor_Lower_co.paa",
			"MA_Armor\data\Vests\Reach_ODST\Canisters_co.paa",
